      ...
      <body>
        ...
        <div id="alternativa" class="alternativa-desk">
          ...
          <div class="row center-align hide-on-med-and-down">
              <input type="text"> <i class="material-icons">add</i>
              <input type="text"> <i class="material-icons">alarm</i>
              <input type="text"> <i class="material-icons">android</i>
        ...
        <div id="dissertativa" class="dissertativa-desk">
          ...
          <div required id="dificuldade-desk" class="input-field center-align hide-on-med-and-down">
          <form action="#">
        ...
        <div required id="priv_public-desk" class=" hide-on-large-only">
